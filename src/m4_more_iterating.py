...
def run_test_count_items_bigger_than():
    ...
    sequence = [45, -84, 32, 701, -10, 40, 101]
    threshold = 100
    expected = 2
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    expected = 3
    actual = count_positive_sines([0, 1, 2, 3, 4, 5, 6])
    print()
...
def run_test_sum_first_n():
    ...
    expected = 28
    actual = sum_first_n([48, -30, 10, 5, 12, 32, 17], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)

    expected = 3
    actual = sum_first_n([1, 2, 3, 4, 5, 6], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
